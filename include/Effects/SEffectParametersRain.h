...
class alignas(8) SEffectParametersRain : public SGBufferUsingEffectParametersBase
{
public:
    ...
    unsigned __int64 m_pVEyeLowerLeft_Offset_RainTest_PS;
    unsigned __int64 m_pVEyeLowerRight_Offset_RainTest_PS;
    unsigned __int64 m_pVEyeUpperLeft_Offset_RainTest_PS;
    unsigned __int64 m_pVEyeUpperRight_Offset_RainTest_PS;
    unsigned __int64 m_CharacterRainParams;
