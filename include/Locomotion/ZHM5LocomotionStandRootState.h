...
class ZHM5LocomotionStandRootState : public ZHM5LocomotionState
{
public:
	bool m_bTurnPlayed;
	...
	~ZHM5LocomotionStandRootState() override = default;
	void Init(ENetworkState eStateType) override;
	void Activate() override;
	void Update(float fDeltaTime) override;

	ZHM5LocomotionStandRootState() = default;
};
